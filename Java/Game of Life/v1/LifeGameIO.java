...
public class LifeGameIO extends LifeGame
{
   ...
   protected boolean readLifeGame(String InputFileName)  throws IOException
   {
       ...
       if(failed == false)
       {
          ...
          if (lifeLine.charAt(1) != '|')                       //attempts to resolve an error were the input takes in an extra line presumably from a character return
            lifeLine = scanner.nextLine();
          // System.out.println("try1: Border = [" + ignoreBorder + "]");
          // Not sure if this is needed to make I/O come out or not...
          ...
          {  
             ...
             lifeLine = scanner.nextLine();
             if (lifeLine.equals(""))                         //attempts to resolve an error were the input takes in an extra line presumably from a character return
               lifeLine = scanner.nextLine();
          } // for
       }  // if
       return failed;
